    ...
    for word in words_to_process:
        try:
         ...
         #   score = judge_adequacy(word, res_t, judge_system_prompt)
            score = judge_adequacy(word, raw_response, judge_prompt)
...
if __name__ == "__main__":
    ...
    [E]
    (1-3 example phrases using this word IN ENGLISH, each on a new line + hyphen + russian translation)
    [P]
    (1-3 well-known phrases (if they are exist) or idioms using this word IN ENGLISH, each on a new line + hyphen + russian translation)"""
    ...
    process_all_words(OUTPUT_FILE, EXCEL_FILE, prompt_en_8_examples, judge_prompt_en_2)
