...
if __name__ == "__main__":
    ...
    # else:
    #     extractor.process_folder(full_set_path, OUTPUT_FILE)

    """ Подготовка таблицы уникальных слов """
    # extractor.analyze_frequency(OUTPUT_FILE, top_n=20)
    # extractor.remove_top_noise(OUTPUT_FILE, noise_count=7)
    # extractor.analyze_frequency(OUTPUT_FILE, top_n=10)
    # extractor.remove_duplicates(OUTPUT_FILE)
    # extractor.analyze_frequency(OUTPUT_FILE, top_n=10)
