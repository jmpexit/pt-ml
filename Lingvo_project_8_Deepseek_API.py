...
from envs import OPENROUTER_TOKEN, HF_TOKEN, DEEPSEEK_API_KEY
...
class BatchEnglishExtractor:
    def __init__(self, api_key):
        ...
        self.client = OpenAI(api_key=api_key,base_url="https://deepseek.com")
        self.model = "deepseek-chat" # Это мощный V3
    ...
    def translate_word(self, word, system_prompt, temperature=0.1):
        ...
        try:
            ...
            if "429" in str(e):
                print("🛑 Лимит DeepSeek. Ждем 15 сек...")
                sleep(15)
    ...
    def judge_adequacy(self, word, translation, judge_system_prompt):
        ...
        try:
            ...
            answer = response.choices[0].message.content  # правильный путь к тексту в DeepSeek API
            ...
            if "429" in str(e):
                print(f"🛑 Лимит DeepSeek для Judge на '{word}'. Ждем 15 сек...")
                sleep(15)
...
if __name__ == "__main__":
    ...
    extractor = BatchEnglishExtractor(api_key=DEEPSEEK_API_KEY)
